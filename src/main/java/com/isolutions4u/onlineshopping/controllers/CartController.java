...
public class CartController {
    ...
    public ModelAndView showCart(@RequestParam(name = "result", required = false) String result) {
        ...
        if (result != null) {
            switch (result) {
                case "updated":
                    modelAndView.addObject("message", "Корзина была успешно обновлена");
                    break;
                ...
                case "added":
                    modelAndView.addObject("message", "Товар был успешно добавлена!");
                    break;

                case "deleted":
                    modelAndView.addObject("message", "Товар был успешно убран");
                    break;
                default:
                    break;
            }
